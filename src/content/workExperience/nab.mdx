...
company: NAB
description: Building and maintaining all apps related to Term Deposits.
...
- Build 9 and maintain 4 customer and banker-facing apps with 100k daily customers using React.js, TypeScript, HTML/CSS, and GraphQL, ensuring accessibility, responsiveness, and performance across devices.
